...
typedef void (*ghostty_surface_host_input_cb)(void*, const uint8_t*, size_t);
...
typedef struct {
  ...
  bool host_managed;
  void* host_managed_userdata;
  ghostty_surface_host_input_cb host_managed_input;
  ghostty_surface_host_resize_cb host_managed_resize;
